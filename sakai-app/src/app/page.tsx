        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-900">Sakai Learning</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
              Sakai Learning provides a modern, intuitive platform for educators and learners. 
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Interactive Content</h3>
                  <p className="text-slate-600">Engage with multimedia learning materials</p>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl">
                  ...
                  <p className="text-slate-600">Monitor your learning journey</p>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-2xl">
                  ...
                  <p className="text-slate-600">Learn together with peers</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-slate-600">Built with Next.js 15 and modern technologies for optimal performance and speed.</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-slate-600">Intuitive design that makes learning enjoyable and accessible for everyone.</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-slate-600">Enterprise-grade security to protect your data and ensure privacy.</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Mobile First</h3>
              <p className="text-slate-600">Learn anywhere, anytime with our responsive mobile-optimized platform.</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Innovative Tools</h3>
              <p className="text-slate-600">Advanced analytics and AI-powered insights to enhance your learning journey.</p>
            </div>
            
            <div className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Community</h3>
              <p className="text-slate-600">Connect with learners worldwide and share knowledge in our vibrant community.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of learners who have already transformed their education with Sakai Learning.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-white text-blue-600 rounded-lg hover:bg-blue-50 transition-all transform hover:scale-105 font-semibold text-lg">
              Get Started Free
            </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">Sakai Learning</span>
              </div>
          ...
          <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">
              © 2024 Sakai Learning. All rights reserved.
            </p>
